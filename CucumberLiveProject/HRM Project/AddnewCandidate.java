...
public class AddnewCandidate {
	...
	WebDriver driver;
    WebDriverWait wait;
    File file = new File("src/test/resources/Resume.doc");
    ...
    public void CandidateInformation() {
    	driver.findElement(By.id("addCandidate_firstName")).sendKeys("Mythili");
    	driver.findElement(By.id("addCandidate_lastName")).sendKeys("Sathya");
    	driver.findElement(By.id("addCandidate_email")).sendKeys("sampletest123@test.com");
    	//Select job title
    ...
    public void Verfication() {	
    	...
    	Name.sendKeys("Mythili Sathya");
    	driver.findElement(By.id("btnSrch")).click();    	    	
    	String JobTitle1 = driver.findElement(By.linkText("Mythili Sathya")).getText();
    	Assert.assertEquals(JobTitle1, "Mythili Sathya"); 
