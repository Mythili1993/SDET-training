...
public class CreateJobVacancies {
    ...
    public void AddVacancies() {
    	...
    	driver.findElement(By.id("addJobVacancy_name")).sendKeys("Sampletest8Vacancy");
    ...
    public void VerifyVacancies() {
    	...
    	dropdown2.selectByVisibleText("Sampletest8Vacancy");
    	...
    	String JobTitle1 = driver.findElement(By.linkText("Sampletest8Vacancy")).getText();
    	Assert.assertEquals(JobTitle1, "Sampletest8Vacancy");  	    
	}
	 @Then("^Verify that the vacancy was created\"(.*)\"$")
